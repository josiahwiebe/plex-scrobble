...
/** Serialized Letterboxd session cookies (persisted for Workers; avoids login on every webhook). */
export interface LetterboxdSessionCookie {
  name: string
  value: string
}
...
export const users = pgTable('users', {
  ...
  letterboxdSessionCookies: jsonb('letterboxd_session_cookies').$type<LetterboxdSessionCookie[] | null>(),
